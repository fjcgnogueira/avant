...
// Caso seja o responsavel da area, ou tenha acesso liberado, ou seja do grupo de administradores
If (dbSeek(xFilial("ZZL")+"1"+RetCodUsr())) .Or. (Posicione("ZZL",01,xFilial("ZZL")+"1"+RetCodUsr()+"1.01","ZZL_PERMIS") == '1') .Or. (aScan(PswRet(1)[1][10],'000000') <> 0)
	MATA240()
Else
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ CondPag()   บ Autor ณ Fernando Nogueira  บ Data ณ07/11/2016บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDescrio ณ Validacao para alteracao da Condicao de Pagamento no Pedidoบฑฑ
ฑฑบ          ณ de Vendas                                                  บฑฑ
ฑฑบ          ณ Chamado 004299                                             บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Especifico AVANT.                   	                      บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
// Caso a condicao de Pagto Seja Antecipada
If M->C5_CONDPAG == '149'
	...
	// Caso seja o responsavel da area, ou tenha acesso liberado, ou seja do grupo de administradores
	If (dbSeek(xFilial("ZZL")+"2"+RetCodUsr())) .Or. (Posicione("ZZL",01,xFilial("ZZL")+"2"+RetCodUsr()+"2.01","ZZL_PERMIS") == '1') .Or. (aScan(PswRet(1)[1][10],'000000') <> 0)
		Return .T.
	Else
		Return .F.
	Endif
