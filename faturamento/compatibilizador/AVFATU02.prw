...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "AVFATU02" )
				Else
					MsgStop( "Atualização não Realizada.", "AVFATU02" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'MOQ'																	, ; //X3_TITSPA
	'MOQ'																	, ; //X3_TITENG
	'Minimum Order Quantity'												, ; //X3_DESCRIC
	'Minimum Order Quantity'												, ; //X3_DESCSPA
	'Minimum Order Quantity'												, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Est.Min.Dias'															, ; //X3_TITULO
	'Est.Min.Dias'															, ; //X3_TITSPA
	'Est.Min.Dias'															, ; //X3_TITENG
	'Estoque Minimo em Dias'												, ; //X3_DESCRIC
	'Estoque Minimo em Dias'												, ; //X3_DESCSPA
	'Estoque Minimo em Dias'												, ; //X3_DESCENG
	'@E 999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Minimum Order Quantity (MOQ) -' )
aAdd( aHlpPor, 'Quantidade mínima de compra.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_X_MOQ  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B1_X_MOQ" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Estoque Mínimo (em dias) é a quantidade' )
aAdd( aHlpPor, 'de estoque ideal que deve ser mantido' )
aAdd( aHlpPor, 'para o produto.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_X_ESTMD", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B1_X_ESTMD" + CRLF
