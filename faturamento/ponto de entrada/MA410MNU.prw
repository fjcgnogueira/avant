...
aAdd(aRotina2,{"Liberacao Fiscal"    ,'U_LibPedFis()', 0, 2, 0, NIL})  // Chamado 003522 - Bloqueio Fiscal - Fernando Nogueira
aAdd(aRotina2,{"Ajuste Fiscal"       ,'U_AjusFis()  ', 0, 2, 0, NIL})  // Chamado 003590 - Ajuste Fiscal   - Fernando Nogueira
...
aAdd(aRotina,{"Fiscal"              ,aRotina2       , 0, 2, 0, NIL})  // Rotinas Fiscais
