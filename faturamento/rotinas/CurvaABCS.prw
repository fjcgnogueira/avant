...
ฑฑบPrograma  ณ CurvaABCS()  บ Autor ณ Fernando Nogueira บ Data ณ 09/05/15 บฑฑ
ฑฑฬออออออออออุออออออออออออออสอออออออฯอออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDesc.     ณ Definicao de Curva ABCS dos Produtos                       บฑฑ
...
BeginSql alias cAliasENT
	...
	WHERE SF1.%notDel% AND F1_FILIAL = %xfilial:SF1% AND ((F1_FORMUL = 'S' AND F1_EST = 'EX') OR (F1_EST <> 'EX' AND F4_DUPLIC = 'S')) AND F1_DTDIGIT BETWEEN %exp:DTOS(Date()-180)% AND %exp:DTOS(Date())%
	GROUP BY D1_COD
	ORDER BY D1_COD
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออออหอออออออัอออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ UltDtEnt()   บ Autor ณ Fernando Nogueira บ Data ณ 27/10/15 บฑฑ
ฑฑฬออออออออออุออออออออออออออสอออออออฯอออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDesc.     ณ Data da Ultima Entrada de nota do Produto                  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Especifico Avant                                           บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
BeginSql alias cAliasULT
	...
	INNER JOIN %table:SD1% SD1 ON F1_FILIAL = D1_FILIAL AND F1_DOC = D1_DOC AND F1_SERIE = D1_SERIE AND F1_FORNECE = D1_FORNECE AND F1_LOJA = D1_LOJA AND SD1.%notDel%
	INNER JOIN %table:SF4% SF4 ON D1_FILIAL = F4_FILIAL AND D1_TES = F4_CODIGO AND F4_ESTOQUE = 'S' AND SF4.%notDel%
	WHERE SF1.%notDel% AND F1_FILIAL = %xfilial:SF1% AND ((F1_FORMUL = 'S' AND F1_EST = 'EX') OR (F1_EST <> 'EX' AND F4_DUPLIC = 'S')) AND D1_LOCAL = '01'
