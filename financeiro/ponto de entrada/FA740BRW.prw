...
Private cLocRar  := "D:\Protheus_data\workflow\xmlnfe\" + cBordero
Private cArqRar  := "D:\Protheus_data\workflow\WinRAR\Rar.exe a -s -m5 D:\Protheus_data\workflow\xmlnfe\" + cBordero + ".rar"
Private lEnviou  := .F.
