...
ฑฑบPrograma  ณ PNEU002  บ Autor ณ Fernando Nogueira   บ Data ณ 21/10/2016 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออสออออออฯออออออออออออนฑฑ
ฑฑบDescricao ณ Ponto de Entrada de uma Devolucao na Amarracao da Nota     บฑฑ
ฑฑบ          ณ Original                                                   บฑฑ
...
If !IsBlind() .And. oApp:nPort <> 1483 .And. cTipo == "D"
	...
	cLog += Replicate( " ", 128 ) + CRLF
	cLog += "LOG DA ENTRADA DE DEVOLUCAO AMARRACAO" + CRLF
	cLog += Replicate( " ", 128 ) + CRLF
	cLog += Replicate( "-", 128 ) + CRLF
	cLog += CRLF
