...
ฑฑบPrograma  ณ MBRWBTN  บ Autor ณ Amedeo D. P. Filho บ Data ณ  24/07/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Ponto de Entrada nos Botoes das MBrowses.                  บฑฑ
ฑฑบ          ณ                                                            บฑฑ
	...
	If AllTrim(FunName()) == "MATA410"
		If nBotao == 9	// Botao Prepara DOC. de Saida
			If Alltrim(Upper(cUserName)) $ "ADMINISTRADOR" .or. Alltrim(Upper(cUserName)) $ "wms"
				lRetorno := .F.
				Alert("Voc๊ nใo tem permissใo para acessar essa Rotina, Contate Suporte")
			EndIf
		EndIf
	EndIf
